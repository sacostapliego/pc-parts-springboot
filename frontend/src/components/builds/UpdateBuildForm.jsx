...
import { updateBuild, getParts } from "../../services/client.js";
...
const UpdateBuildForm = ({ fetchBuilds, initialValues, buildId, onClose }) => {
        ...
        <>
            <Formik
                ...
                onSubmit={(updatedBuild, { setSubmitting }) => {
                    setSubmitting(true);
                    updateBuild(buildId, updatedBuild)
                        .then(res => {
                            successNotification(
                                "Build updated",
                                `${updatedBuild.name} was successfully updated`
                            );
                            fetchBuilds();
                            onClose();
                        }).catch(err => {
