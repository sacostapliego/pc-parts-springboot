...
public class CustomerJDBCDataAccessService implements CustomerDao {
    ...
    public List<Customer> selectAllCustomers() {
        var sql = """
                SELECT id, name, email, password, age, gender, role, profile_image_id
                FROM customer
                LIMIT 1000
                """;
    ...
    public void updateCustomerProfileImageId(String profileImageId,
        ...
        try {
            ...
            System.out.println("Update profile image result = " + result); // Debug line
            if (result != 1) {
                throw new IllegalStateException(
                    "Failed to update profile image. Updated " + result + " rows.");
            }
        } catch (Exception e) {
