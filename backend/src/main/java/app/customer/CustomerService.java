...
import app.s3.S3Buckets;
import app.s3.S3Service;
...
public class CustomerService {
    ...
    public void uploadCustomerProfileImage(Integer customerId,
        ...
        System.out.println("Generated profileImageId: " + profileImageId); // Debug line
        ...
        try {
            ...
            System.out.println("Successfully uploaded to S3"); // Debug line
            customerDao.updateCustomerProfileImageId(profileImageId, customerId);
            System.out.println("Successfully updated database"); // Debug line
        } catch (IOException e) {
